...
class Achatcontroller extends Controller
{
 /**
    ...
    // $sites = Site::where('isActive', true)->get();
        ...
        return view('achat.index',  compact('achats' , 'sites'));
    }
    ...
    public function getData1($sites_id=null){
        ...
        foreach ($achats as $key => $achat) {
            ...
            $enabled = $achat->isActive ? "Désactiver" : "Activer";
            ...
            $data[$key] = [
                ...
                'by'                => $achat->users->lastname.' '.$achat->users->firstname,
